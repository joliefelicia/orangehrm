...
WebUI.setText(findTestObject('admin/input_Type for hints'), employeername)

WebUI.click(findTestObject('admin/button_Search'))

WebUI.delay(5)

WebUI.click(findTestObject('admin/button_Reset'))
